...
if date_text ~= "1970-01-01 00:00:00" or date_ordinal ~= "4:001" or date_names ~= "Thu:Thursday:Jan:January" or date_table.year ~= 1970 or date_table.month ~= 1 or date_table.day ~= 1 or date_table.hour ~= 0 or date_table.min ~= 0 or date_table.sec ~= 0 or date_table.isdst ~= false then
